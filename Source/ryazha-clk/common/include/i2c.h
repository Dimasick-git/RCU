 ...
 *
 * Unified I2C header. Этот файл -- единая правда о I2C-регистрах,
 * BuckConverter doменах и BQ24193. Раньше существовали две расходящиеся
 * копии: common/include/i2c.h и sysmodule/src/i2c/i2cDrv.h. Обе
 * подтягивались в один TU sysmodule'а -> redefinition errors.
 *
 * Теперь i2cDrv.h в sysmodule -- thin shim, который #include'ит этот файл.
 */
...
// Расширенный набор доменов: SOC и VDD2 пришли из i2cDrv.h-варианта,
// Erista_DRAM и Mariko_DRAM_VDD2 -- из common'a. Объединено здесь.
// (I2c_Display mask 0x3F взят из newer i2cDrv.h версии.)
